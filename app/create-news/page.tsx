...
export default function NewsDashboard() {
  ...
  const createNews = async (workData: any) => {
    try {
  ...
  const updateNews = async (workData: any) => {
    try {
      ...
      if (data.success) {
        ...
        // setNews((prevBlogs) =>
        //   prevBlogs.map((blog) =>
        //     blog.id === currentNews.id ? currentNews : blog
        //   )
        // );
        setcurrentNews({
          id: "",
  ...
  // Edit a work
  const handleEditNews = (work: News) => {
    setcurrentNews(work);
    setView("edit");
  };
  ...
  const handleAddTag = () => {
    if (newTag.trim() && !currentNews.tags.includes(newTag.trim())) {
      setcurrentNews({
        ...currentNews,
        tags: [...currentNews.tags, newTag.trim()],
      });
      setNewTag("");
    }
  };
  ...
  const handleRemoveTag = (tagToRemove: string) => {
    setcurrentNews({
      ...currentNews,
      tags: currentNews.tags.filter((tag) => tag !== tagToRemove),
    });
  };
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={() => handledeleteNews(blog.id)}
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end space-x-4 pt-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={
                    view === "create" ? handlecreateNews : handleupdateNews
                  }
